...
* Select `mossotest.sln` into your project root folder
...
Set properties in: `mossotest/Properties.cs`

* The first time you start the app you have to update the NuGet Packages:
    * Right click on Solution `mossotest`
...
* For Android, the Minimum Android Version for debugging is set to "Android 4.4". If you wish to lower it:
    * Right click on `mossotest.Android`
    * Properties
    * Android Manifest
